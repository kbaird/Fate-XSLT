 ...
 <xsl:template match="character">
  ...
  <html>
   ...
   <body>
    ...
    <hr />
    <div id="aspects"><xsl:apply-templates select="aspects"/></div>
    <div id="skills">
    ...
    <hr />
    <div id="extras"><xsl:apply-templates select="extras"/></div>
    <div id="stunts"><xsl:apply-templates select="stunts"/></div>
    <hr />
    <div id="stress">
